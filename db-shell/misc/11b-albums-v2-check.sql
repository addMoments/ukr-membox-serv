-- 11b — Albumler v2, ikinci adim: "photo/video her zaman albumlu" kisiti (3b'nin aynisi).
--
-- 11-albums-v2.sql'den AYRI cunku yeni membox-serv deploy edilmeden once calisirsa eski
-- (albumsuz) backend photo yuklemelerini album_uid olmadan ekler ve kisit misafir
-- yuklemelerini patlatirdi. Backend ve frontend canlida yenilendikten SONRA calistirilir.
--
